...
| **사진**   | **이름**   | **역할 및 담당**                                  |  
|------------|------------|---------------------------------------------------|  
| <img src="https://github.com/user-attachments/assets/d46834c6-acbb-40e6-b747-242e0cab07b8" width="100" height="130"> | **김동진** | **프로젝트 매니저** <br> 프로젝트 진행 및 관리 <br> 팀 커뮤니케이션 조율 |
